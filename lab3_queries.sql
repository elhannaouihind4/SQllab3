...
SELECT * FROM Ouvrage ORDER BY id_ouvrage DESC LIMIT 3;


SELECT nom, LENGTH(nom) AS longueur FROM Auteur WHERE LENGTH(nom) >= 5;


SELECT * FROM Abonne WHERE email NOT LIKE '%@example.com';
